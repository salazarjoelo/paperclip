...
export function OrgChart() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t('org_chart.title') }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t('org_chart.select_company')} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t('org_chart.empty_hierarchy')} />;
  }
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-1.5">
          <button
            ...
            aria-label={t('org_chart.zoom_in')}
          >
          ...
          <button
            ...
            aria-label={t('org_chart.zoom_out')}
          >
          ...
          <button
            ...
            onClick={fitToScreen}
            title={t('org_chart.fit_to_screen')}
